...
class Peak(_object):
    ...
    if _newclass:x = _swig_property(_pafprocess.Peak_x_get, _pafprocess.Peak_x_set)
    __swig_setmethods__["y"] = _pafprocess.Peak_y_set
    __swig_getmethods__["y"] = _pafprocess.Peak_y_get
    if _newclass:y = _swig_property(_pafprocess.Peak_y_get, _pafprocess.Peak_y_set)
    __swig_setmethods__["score"] = _pafprocess.Peak_score_set
    __swig_getmethods__["score"] = _pafprocess.Peak_score_get
    if _newclass:score = _swig_property(_pafprocess.Peak_score_get, _pafprocess.Peak_score_set)
    __swig_setmethods__["id"] = _pafprocess.Peak_id_set
    __swig_getmethods__["id"] = _pafprocess.Peak_id_get
    if _newclass:id = _swig_property(_pafprocess.Peak_id_get, _pafprocess.Peak_id_set)
    def __init__(self): 
...
class VectorXY(_object):
    ...
    if _newclass:x = _swig_property(_pafprocess.VectorXY_x_get, _pafprocess.VectorXY_x_set)
    __swig_setmethods__["y"] = _pafprocess.VectorXY_y_set
    __swig_getmethods__["y"] = _pafprocess.VectorXY_y_get
    if _newclass:y = _swig_property(_pafprocess.VectorXY_y_get, _pafprocess.VectorXY_y_set)
    def __init__(self): 
...
class ConnectionCandidate(_object):
    ...
    if _newclass:idx1 = _swig_property(_pafprocess.ConnectionCandidate_idx1_get, _pafprocess.ConnectionCandidate_idx1_set)
    ...
    if _newclass:idx2 = _swig_property(_pafprocess.ConnectionCandidate_idx2_get, _pafprocess.ConnectionCandidate_idx2_set)
    ...
    if _newclass:score = _swig_property(_pafprocess.ConnectionCandidate_score_get, _pafprocess.ConnectionCandidate_score_set)
    ...
    if _newclass:etc = _swig_property(_pafprocess.ConnectionCandidate_etc_get, _pafprocess.ConnectionCandidate_etc_set)
    def __init__(self): 
...
class Connection(_object):
    ...
    if _newclass:cid1 = _swig_property(_pafprocess.Connection_cid1_get, _pafprocess.Connection_cid1_set)
    __swig_setmethods__["cid2"] = _pafprocess.Connection_cid2_set
    __swig_getmethods__["cid2"] = _pafprocess.Connection_cid2_get
    if _newclass:cid2 = _swig_property(_pafprocess.Connection_cid2_get, _pafprocess.Connection_cid2_set)
    __swig_setmethods__["score"] = _pafprocess.Connection_score_set
    __swig_getmethods__["score"] = _pafprocess.Connection_score_get
    if _newclass:score = _swig_property(_pafprocess.Connection_score_get, _pafprocess.Connection_score_set)
    ...
    if _newclass:peak_id1 = _swig_property(_pafprocess.Connection_peak_id1_get, _pafprocess.Connection_peak_id1_set)
    ...
    if _newclass:peak_id2 = _swig_property(_pafprocess.Connection_peak_id2_get, _pafprocess.Connection_peak_id2_set)
    def __init__(self): 
...
def get_part_cid(*args):
  return _pafprocess.get_part_cid(*args)
...
def get_part_x(*args):
  return _pafprocess.get_part_x(*args)
get_part_x = _pafprocess.get_part_x

def get_part_y(*args):
  return _pafprocess.get_part_y(*args)
get_part_y = _pafprocess.get_part_y

def get_part_score(*args):
  return _pafprocess.get_part_score(*args)
